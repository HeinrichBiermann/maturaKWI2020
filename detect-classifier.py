...
ap.add_argument("-r", "--roisize", type = str, default = "(128, 128)",
    help = "ROI size (in pixels)")
ap.add_argument("-c", "--minconf", type = int, default = 0.95,
...
def detect_classify(original, model, labelbinarizer):
    ...
    #display = final_label + str(int(acc * 100))
    cv2.putText(original, final_label, (startX, y),
